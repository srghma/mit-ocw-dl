#!/usr/bin/env node
// ./find-pdfs-convert-images.js /home/srghma/Desktop/14-01sc-principles-of-microeconomics-fall-2011/
...
async function extractImages(pdfFilePath) {
  ...
  try {
    await exec(`pdftoppm -jpeg "${pdfFilePath}" "${outputPath}"`)
    // await exec(`pdfimages -all "${pdfFilePath}" "${outputPath}"`)
